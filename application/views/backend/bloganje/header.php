...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('base_url') ?>application/views/backend/bloganje/css/theme.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('base_url') ?>application/views/backend/bloganje/css/style.css" />
	<?php if ( $this->config->item('language') == 'arabic' ) : ?>
	<link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('base_url') ?>application/views/backend/bloganje/css/style-rtl.css" />
	<?php endif; ?>
	<script type="text/javascript" src="<?php echo $this->config->item('base_url') ?>application/views/backend/js/jquery.js"></script>
	<script type="text/javascript" src="<?php echo $this->config->item('base_url') ?>application/views/backend/js/jquery.simpletip.js"></script>
	<script>
		var StyleFile = "theme" + document.cookie.charAt(6) + ".css";
		document.writeln('<link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('base_url') ?>application/views/backend/bloganje/css/' + StyleFile + '">');
		$().ready( function(){
	...
	<!--[if IE]>
	<link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('base_url') ?>application/views/backend/bloganje/css/ie-sucks.css" />
	<![endif]-->
</head>
<body>
